  ...
  <div class="wrap">
	<div class="header">
		<div class="headertop_desc">
			<div class="call">
				 <p><span>百度呼唤平台</span><span class="number"></span></span></p>
			</div>
	...
	<div class="header_bottom">
	     	<div class="menu">
	     		<ul>
			    	...
			    	<li><a href="myJoin.html">我的参与</a></li>
			    	<li><a href="myReward.html">我的回报</a></li>
                    <li><a href="myOrder.html">我的定单</a></li>
			    	<div class="clear"></div>
     			</ul>
	     	</div>
	     	<div class="search_box">
	     		<form action="allPros.html">
 ...
 <div class="main">
    <div class="content">
    	<div class="content_top">
    		...
    		<div class="see">
    			<p><a href="allPros.html">查看所有项目</a></p>
    		</div>
    		<div class="clear"></div>
    	</div>
	      <div class="section group">
				<div class="grid_1_of_4 images_1_of_4">
					 <a href="proInfo.html"><img src="images/feature-pic1.jpg" alt="" /></a>
					 <h2>张学友演唱会</h2>
				       ...
				       <div class="price-number">
							<p><span class="rupees"></span></p>
                                ...
                                <div class="add-cart" style="margin-right:2px;">								
									<h4><a href="javascript:location.href='huhuan.html'">呼唤</a></h4>
							    </div>
							 <div class="clear"></div>
					</div>
